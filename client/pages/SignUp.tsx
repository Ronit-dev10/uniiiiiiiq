            ...
            <div className="flex flex-wrap justify-center items-center gap-2 mb-2">
              ...
              <div className="flex items-start">
                ...
                <span
                  ...
                  style={{
                    background:
                      "linear-gradient(140deg, #9FB971 9.66%, #FFD965 42.74%, #C17C74 74.68%, #467896 102.63%)",
          ...
          <div className="max-w-[656px] mx-auto border border-uniiq-neutral-200 rounded-[14px] p-6 lg:p-8 bg-white">
            <form onSubmit={handleSubmit} className="space-y-7">
              ...
              <div className="space-y-2">
                <h1 className="font-bold text-[28px] text-uniiq-neutral-1200">
                  Sign up
                </h1>
              </div>
              ...
              <div className="space-y-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  <div className="flex flex-col gap-2.5">
                    ...
                    <div className="flex items-center gap-4 p-2 rounded border border-uniiq-neutral-200 bg-white">
                      <div
                        className="flex items-center gap-1 px-[6px] py-[7px]
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <Link
                      to="#"
                      className="font-bold text-uniiq-blue-link hover:underline"
                    >
                      Newsletter.
                    </Link>
                  </Checkbox>
